...
namespace QLyBakery.Controllers
{
    public class NhaCungCapsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "NhacungcapID,TenNhacungcap,SoDienThoai,DiaChi,SoTaiKhoan,Email")] NhaCungCap nhaCungCap)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "NhacungcapID,TenNhacungcap,SoDienThoai,DiaChi,SoTaiKhoan,Email")] NhaCungCap nhaCungCap)
        {
            if (ModelState.IsValid)
            {
