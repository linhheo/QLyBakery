...
namespace QLyBakery.Controllers
{
    ...
    public class KhosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "NguyenlieuID,TenNguyenlieu,Soluong")] Kho kho)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "NguyenlieuID,TenNguyenlieu,Soluong")] Kho kho)
        {
            if (ModelState.IsValid)
            {
